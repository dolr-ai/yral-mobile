...
import com.yral.shared.core.AppConfigurations.TOURNAMENT_FEED_BASE_URL
...
class FeedRemoteDataSource(
    ...
    override suspend fun getTournamentFeeds(
        ...
        httpGet(
            ...
            url {
                host = TOURNAMENT_FEED_BASE_URL
                path(TOURNAMENT_FEED_PATH, tournamentId, TOURNAMENT_FEED_VIDEOS_PATH)
                parameters.append("with_metadata", withMetadata.toString())
            }
        }
    ...
    companion object {
        ...
        private const val TOURNAMENT_FEED_PATH = "tournament"
