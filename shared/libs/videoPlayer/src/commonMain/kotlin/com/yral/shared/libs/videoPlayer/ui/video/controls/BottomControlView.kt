...
import com.yral.shared.libs.videoPlayer.ui.component.TimeDurationView
import com.yral.shared.libs.videoPlayer.util.formatYoutubeInterval
                        ...
                        Column(
                            ...
                            if (playerConfig.isDurationVisible) {
                                TimeDurationView(
                                    ...
                                    currentTime =
                                        if (isYoutube) {
                                            formatYoutubeInterval(currentTime)
                                        } else {
                                            currentTime
                                        },
                                    totalTime =
