    ...
    object Chat :
        ...
        val H2hChatEnabled: FeatureFlag<Boolean> =
            boolean(
                ...
                description =
                    "When ON, exposes the Send Message button on other-user profile screens and " +
        ...
        val AudioRecordingEnabled: FeatureFlag<Boolean> =
            boolean(
                ...
                description =
                    "When ON, exposes the mic button in the chat input action row so users can " +
        ...
        val VideoIdeasEnabled: FeatureFlag<Boolean> =
            boolean(
                ...
                description =
                    "When ON, exposes the third \"Ideas\" tab (lightbulb icon) on a creator's own " +
        ...
        val DiscoveryFeedV2Enabled: FeatureFlag<Boolean> =
            boolean(
                ...
                description =
                    "When ON, the influencer discovery screen fetches its list from " +
        ...
        val RequireAuthBeforeFirstSend: FeatureFlag<Boolean> =
            boolean(
                ...
                description =
                    "When ON, the contextual login sheet is shown the very first time an " +
        ...
        val DiscoverySearchEnabled: FeatureFlag<Boolean> =
            boolean(
                ...
                description =
                    "When ON, the Discover header on the chat home screen replaces the " +
