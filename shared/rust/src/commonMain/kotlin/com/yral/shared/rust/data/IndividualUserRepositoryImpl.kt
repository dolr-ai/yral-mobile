...
class IndividualUserRepositoryImpl(private val dataSource: IndividualUserDataSource) : IndividualUserRepository {

    override suspend fun getPostsOfThisUserProfileWithPaginationCursor(
        pageNo: ULong
    ): List<PostDetailsForFrontend> {
        val result = dataSource.getPostsOfThisUserProfileWithPaginationCursor(
            pageNo = pageNo,
        )
