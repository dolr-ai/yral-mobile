...
impl Service {
    ...
    pub async fn error_refund_icp(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "error_refund_icp")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn finalize_swap(&self, arg0: FinalizeSwapArg) -> Result<FinalizeSwapResponse> {
        ...
        let bytes = self
            .agent
            .update(&self.principal, "finalize_swap")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn get_auto_finalization_status(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_auto_finalization_status")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_buyer_state(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_buyer_state")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_buyers_total(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "get_buyers_total")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn get_canister_status(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "get_canister_status")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn get_derived_state(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_derived_state")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_lifecycle(&self, arg0: GetLifecycleArg) -> Result<GetLifecycleResponse> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_lifecycle")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_open_ticket(&self, arg0: GetOpenTicketArg) -> Result<GetOpenTicketResponse> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_open_ticket")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_sale_parameters(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_sale_parameters")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_state(&self, arg0: GetStateArg) -> Result<GetStateResponse> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_state")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn list_community_fund_participants(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "list_community_fund_participants")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn list_direct_participants(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "list_direct_participants")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn list_sns_neuron_recipes(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "list_sns_neuron_recipes")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn new_sale_ticket(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "new_sale_ticket")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn notify_payment_failure(&self, arg0: NotifyPaymentFailureArg) -> Result<Ok2> {
        ...
        let bytes = self
            .agent
            .update(&self.principal, "notify_payment_failure")
            .with_arg(args)
            .call_and_wait()
            .await?;
        Ok(Decode!(&bytes, Ok2)?)
    ...
    pub async fn refresh_buyer_tokens(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "refresh_buyer_tokens")
            .with_arg(args)
            .call_and_wait()
            .await?;
