...
impl Service {
    ...
    pub async fn get_blocks(&self, arg0: GetBlocksArgs) -> Result<GetBlocksResponse> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_blocks")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_data_certificate(&self) -> Result<DataCertificate> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_data_certificate")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_transactions(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_transactions")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_1_decimals(&self) -> Result<u8> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_decimals")
            .with_arg(args)
            .call()
            .await?;
        Ok(Decode!(&bytes, u8)?)
    ...
    pub async fn icrc_1_fee(&self) -> Result<Tokens> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_fee")
            .with_arg(args)
            .call()
            .await?;
        Ok(Decode!(&bytes, Tokens)?)
    ...
    pub async fn icrc_1_metadata(&self) -> Result<Vec<MetadataEntry>> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_metadata")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_1_minting_account(&self) -> Result<AccountResult> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_minting_account")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_1_name(&self) -> Result<String> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_name")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_1_supported_standards(&self) -> Result<Vec<StandardRecord>> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_supported_standards")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_1_symbol(&self) -> Result<String> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_symbol")
            .with_arg(args)
            .call()
            .await?;
        Ok(Decode!(&bytes, String)?)
    ...
    pub async fn icrc_1_total_supply(&self) -> Result<Tokens> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc1_total_supply")
            .with_arg(args)
            .call()
            .await?;
        Ok(Decode!(&bytes, Tokens)?)
    ...
    pub async fn icrc_2_allowance(&self, arg0: AllowanceArgs) -> Result<Allowance> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc2_allowance")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_3_get_archives(&self, arg0: GetArchivesArgs) -> Result<GetArchivesResult> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc3_get_archives")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_3_get_blocks(&self, arg0: Vec<GetBlocksArgs>) -> Result<GetBlocksResult> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc3_get_blocks")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_3_get_tip_certificate(&self) -> Result<Icrc3DataCertificateResult> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc3_get_tip_certificate")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn icrc_3_supported_block_types(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "icrc3_supported_block_types")
            .with_arg(args)
            .call()
            .await?;
