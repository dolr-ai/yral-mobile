...
impl<'a> Service<'a> {
  pub async fn claim_swap_neurons(&self, arg0: ClaimSwapNeuronsRequest) -> Result<ClaimSwapNeuronsResponse> {
    ...
    let bytes = self.1.update(&self.0, "claim_swap_neurons").with_arg(args).call_and_wait().await?;
  ...
  pub async fn fail_stuck_upgrade_in_progress(&self, arg0: FailStuckUpgradeInProgressArg) -> Result<FailStuckUpgradeInProgressRet> {
    let args = Encode!(&arg0)?;
    let bytes = self.1.update(&self.0, "fail_stuck_upgrade_in_progress").with_arg(args).call_and_wait().await?;
  ...
  pub async fn get_latest_reward_event(&self) -> Result<RewardEvent> {
    let args = Encode!()?;
    let bytes = self.1.query(&self.0, "get_latest_reward_event").with_arg(args).call().await?;
  ...
  pub async fn get_maturity_modulation(&self, arg0: GetMaturityModulationArg) -> Result<GetMaturityModulationResponse> {
    let args = Encode!(&arg0)?;
    let bytes = self.1.update(&self.0, "get_maturity_modulation").with_arg(args).call_and_wait().await?;
  ...
  pub async fn get_running_sns_version(&self, arg0: GetRunningSnsVersionArg) -> Result<GetRunningSnsVersionResponse> {
    let args = Encode!(&arg0)?;
    let bytes = self.1.query(&self.0, "get_running_sns_version").with_arg(args).call().await?;
  ...
  pub async fn get_sns_initialization_parameters(&self, arg0: GetSnsInitializationParametersArg) -> Result<GetSnsInitializationParametersResponse> {
    let args = Encode!(&arg0)?;
    let bytes = self.1.query(&self.0, "get_sns_initialization_parameters").with_arg(args).call().await?;
  ...
  pub async fn list_nervous_system_functions(&self) -> Result<ListNervousSystemFunctionsResponse> {
    let args = Encode!()?;
    let bytes = self.1.query(&self.0, "list_nervous_system_functions").with_arg(args).call().await?;
