...
impl Service {
    ...
    pub async fn claim_swap_neurons(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "claim_swap_neurons")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn fail_stuck_upgrade_in_progress(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "fail_stuck_upgrade_in_progress")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn get_latest_reward_event(&self) -> Result<RewardEvent> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_latest_reward_event")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_maturity_modulation(
        ...
        let bytes = self
            .agent
            .update(&self.principal, "get_maturity_modulation")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn get_metadata(&self, arg0: GetMetadataArg) -> Result<GetMetadataResponse> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_metadata")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_proposal(&self, arg0: GetProposal) -> Result<GetProposalResponse> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_proposal")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_root_canister_status(&self, arg0: ()) -> Result<CanisterStatusResultV2> {
        ...
        let bytes = self
            .agent
            .update(&self.principal, "get_root_canister_status")
            .with_arg(args)
            .call_and_wait()
            .await?;
    ...
    pub async fn get_running_sns_version(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_running_sns_version")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn get_sns_initialization_parameters(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "get_sns_initialization_parameters")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn list_nervous_system_functions(
        ...
        let bytes = self
            .agent
            .query(&self.principal, "list_nervous_system_functions")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn list_neurons(&self, arg0: ListNeurons) -> Result<ListNeuronsResponse> {
        ...
        let bytes = self
            .agent
            .query(&self.principal, "list_neurons")
            .with_arg(args)
            .call()
            .await?;
    ...
    pub async fn set_mode(&self, arg0: SetMode) -> Result<SetModeRet> {
        ...
        let bytes = self
            .agent
            .update(&self.principal, "set_mode")
            .with_arg(args)
            .call_and_wait()
            .await?;
