...
mod ffi {
    ...
    extern "Rust" {
        ...
        async fn canister_status(
            &self,
            arg0: CanisterIdRecord,
        ) -> Result<CanisterStatusResult, AgentError>;
