...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1677 // ci:staging-version-code
            versionName = "2.8.80" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 97 // ci:prod-version-code
            versionName = "2.8.17" // ci:prod-version-name
