...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1684 // ci:staging-version-code
            versionName = "2.8.87" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 100 // ci:prod-version-code
            versionName = "3.4.2" // ci:prod-version-name
