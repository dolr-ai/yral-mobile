...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1662 // ci:staging-version-code
            versionName = "2.8.65" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 95 // ci:prod-version-code
            versionName = "2.8.15" // ci:prod-version-name
