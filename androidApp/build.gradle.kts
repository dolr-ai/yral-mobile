...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1600 // ci:staging-version-code
            versionName = "2.8.4" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 82 // ci:prod-version-code
            versionName = "2.8.3" // ci:prod-version-name
