...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1694 // ci:staging-version-code
            versionName = "2.8.97" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 102 // ci:prod-version-code
            versionName = "3.4.4" // ci:prod-version-name
