...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1698 // ci:staging-version-code
            versionName = "2.8.101" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 103 // ci:prod-version-code
            versionName = "3.4.5" // ci:prod-version-name
