...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1650 // ci:staging-version-code
            versionName = "2.8.53" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 93 // ci:prod-version-code
            versionName = "2.8.13" // ci:prod-version-name
