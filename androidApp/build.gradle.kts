...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1652 // ci:staging-version-code
            versionName = "2.8.55" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 94 // ci:prod-version-code
            versionName = "2.8.14" // ci:prod-version-name
