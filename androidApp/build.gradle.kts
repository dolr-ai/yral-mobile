...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1664 // ci:staging-version-code
            versionName = "2.8.67" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 96 // ci:prod-version-code
            versionName = "2.8.16" // ci:prod-version-name
