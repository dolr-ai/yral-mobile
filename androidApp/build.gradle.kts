...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1679 // ci:staging-version-code
            versionName = "2.8.82" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 99 // ci:prod-version-code
            versionName = "2.9.1" // ci:prod-version-name
