...
android {
    ...
    productFlavors {
        create("staging") {
            dimension = "version"
            versionCode = 1646 // ci:staging-version-code
            versionName = "2.8.49" // ci:staging-version-name
            signingConfig = signingConfigs.getByName("staging")
        }
        create("prod") {
            applicationId = "com.yral.android.app"
            dimension = "version"
            versionCode = 92 // ci:prod-version-code
            versionName = "2.8.12" // ci:prod-version-name
